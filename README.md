...
**商 = 128 + 64 + 32 + 16 + 8 + 2 = 250** （6回で計算完了）

つまり除算とは「**大きい塊から順に、引けるだけ引いて、何倍分引いたか数える**」こと。
...
どちらも同じ質問をしている。違いは「質問の準備」の仕方だけ：

```
筆算:  まず 4→8→16→32 と大きくして、16から質問開始
再帰:  4→8→16→32 と潜っていき、戻りながら質問する
```

例えるなら：
- **筆算**: 階段を上ってから、降りながら確認
- **再帰**: 上りながら「後で確認」と言って、降りるときに確認

結局やっていることは同じ。再帰は「書き方の違い」だけ。
